...
void drawHtml(EthernetClient client, String irQueryValue) {
  ...
  //  }
	...
	client.println(F("<li><a href='/tv-volume-up' >TV Volume Up</a></li>"));
	client.println(F("<li><a href='/tv-volume-down' >TV Volume Down</a></li>"));
	client.println(F("<li><a href='/tv-power-on' >TV Power On</a></li>"));
	client.println(F("<li><a href='/tv-power-off' >TV Power Off</a></li>"));

	client.println(F("<li><a href='/capture-ir' >Capture IR</a></li>"));
